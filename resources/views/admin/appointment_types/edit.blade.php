...
<div class="mb-4">
    ...
    <h2 class="fw-bold mb-0 mt-2">Editar Tipo de Turno</h2>
    <p class="text-muted">Modificá la configuración del servicio seleccionado.</p>
</div>

<div class="row">
    <div class="col-md-8">
        <div class="card shadow-sm border-0 bg-white">
            <form action="{{ route('admin.appointment-types.update', $appointmentType) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body p-4">
                    <div class="mb-3">
                        <label for="name" class="form-label fw-bold small text-dark">Nombre del Servicio / Consulta</label>
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $appointmentType->name) }}" placeholder="Ej: Primera Consulta, Limpieza Completa, Extracción" required>
                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="duration" id="duration" class="form-control @error('duration') is-invalid @enderror" value="{{ old('duration', $appointmentType->duration) }}" min="5" max="1440" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" id="price" step="0.01" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $appointmentType->price) }}" placeholder="0.00" min="0">
                                </div>
                    ...
                    <div class="mb-3 mt-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $appointmentType->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>
